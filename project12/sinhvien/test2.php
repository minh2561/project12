...
<div class="main-content bg-light" style="height: 500px;">
    <div class="container">
        ...
        <form class="d-flex px-5 mb-4">
            <input <?php if ($checkTrangThai == 'Đóng') {echo 'disabled';}; ?> class="form-control me-2 " type="search" placeholder="Nhập môn học muốn đăng kí" onchange="handleGetName(this.value)">
            <button <?php if ($checkTrangThai == 'Đóng') {echo 'disabled';}; ?> id =""  class =" btn btn-success" type="submit"><a id="hrefSearch">Search</a></button>
        </form>
